...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * TODO (Task 1)[Done]: Create another constructor that takes in TWO parameters,
    ...
    public static void main(String[] args) {
        ...
        /**
         * TODO (Task 2)[Done]: Below are a bunch of calls to countStatic using
    ...
    public String toString(){
        // TODO (Task 3)[Done]: Implement the body of this method!
        return this.name;
    }
    ...
    public boolean equals(Object o) {
        /**
         * TODO (Task 4)[Done]: Complete the body of this method!
    ...
    public int compareTo(Silly other) {
        /**
         * TODO (Task 5)[Done]: Implement the body of this method.
